...
@media screen and (max-width: 768px){
	...
	<?php if (!$layout['cell_autosize']): ?>
		div#uber-grid-wrapper-<?php echo $this->id ?>{
			min-width: <?php echo $this->responsive_768_get_columns_width($this->has_2x_cells($cells) ? 2 : 1)?>px !important;
		}
	<?php endif ?>
}
...
@media screen and (max-width: 440px){
	...
	<?php if (!$layout['cell_autosize']): ?>
		div#uber-grid-wrapper-<?php echo $this->id ?>{
			min-width: <?php echo $this->responsive_440_get_columns_width($this->has_2x_cells($cells) ? 2 : 1)?>px !important;
		}
	<?php endif ?>
}
