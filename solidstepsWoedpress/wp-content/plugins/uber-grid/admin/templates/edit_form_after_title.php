...
<h2 class="nav-tab-wrapper">
	...
	<a href="admin.php?page=uber-grid-image-troubleshooting-easy" target="_blank" class="button-primary" style="float: right; margin-right: 1.5em"><?php _e('Images not showing?') ?></a>
