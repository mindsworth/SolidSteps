...
<div id="fonts">
	...
	<p>
		...
		<select role="font"   rv-font-family=":lightbox_title:family"><option value=""><?php _e('Default', 'uber-grid')?></option></select>
		<select role="style"  rv-value=":lightbox_title:style"><option value=""><?php _e('Default', 'uber-grid')?></option></select>
		<input  type="number" rv-value=":lightbox_title:size">px
		<label><?php _e('Lightbox text font', 'uber-grid')?></label>
		<select role="font"   rv-font-family=":lightbox_text:family"><option value=""><?php _e('Default', 'uber-grid')?></option></select>
		<select role="style"  rv-value=":lightbox:text:style"><option value=""><?php _e('Default', 'uber-grid')?></option></select>
		<input  type="number" rv-value=":lightbox_text:size">px
	</p>
	<p>
